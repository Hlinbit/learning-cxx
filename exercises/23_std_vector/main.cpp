...
int main(int argc, char **argv) {
    {
        ...
        int ans[]{1, 2, 3, 4, 5};
        ASSERT(std::memcmp(vec.data(), ans, sizeof(int)) == 0, "Fill in the correct values.");
    }
    {
        std::vector<double> vec{1, 2, 3, 4, 5};
        {
            ...
            ASSERT(std::memcmp(vec.data(), ans, sizeof(double) * vec.size()) == 0, "Fill in the correct values.");
        }
        {
            vec.push_back(6);
